...
/**
 * Utility class that provides various data validation methods used throughout
 * the application such as checking null, numbers, email format, names, roll
 * numbers, password strength, phone numbers and date validations.
 *
...
public class DataValidator {
	...
	/**
	 * Checks whether a value is a valid long number.
	 */
	...
	/**
	 * Validates a name containing alphabets and allowed characters.
	 */
	...
	/**
	 * Checks password length only (8–12 characters).
	 */
	...
	/**
	 * Validates Indian phone number starting with 6–9 and having 10 digits.
	 */
	...
	/**
	 * Checks if provided string can be parsed as a valid date.
	 */
	...
	/**
	 * Checks whether given date falls on Sunday.
	 */
	...
	/**
	 * Main method for manually testing validators.
	 */
