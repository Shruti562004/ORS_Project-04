...
public interface ORSView {
	...
	public String GYMWORKOUT_VIEW = PAGE_FOLDER + "/Gymworkout.jsp";
	public String GYMWORKOUT_CTL = APP_CONTEXT + "/ctl/GymworkoutCtl";
	
	public String GYMWORKOUT_LIST_VIEW = PAGE_FOLDER + "/GymworkoutList.jsp";
	...
	public String BLOOD_VIEW = PAGE_FOLDER + "/BloodView.jsp";
	public String  BLOOD_CTL = APP_CONTEXT + "/ctl/BloodCtl";
	
	public String BLOOD__LIST_VIEW = PAGE_FOLDER + "/BloodListView.jsp";
	public String  BLOOD__LIST_CTL = APP_CONTEXT + "/ctl/BloodListCtl";
	

public  String ADVERTISE_VIEW= PAGE_FOLDER + "/AdvertiseView.jsp";
public  String ADVERTISE_CTL = APP_CONTEXT + "/ctl/AdvertiseCtl";
	
public  String ADVERTISE_LIST_VIEW= PAGE_FOLDER + "/AdvertiselistView.jsp";
public  String ADVERTISE_LIST_CTL = APP_CONTEXT + "/ctl/AdvertiseListCtl";
