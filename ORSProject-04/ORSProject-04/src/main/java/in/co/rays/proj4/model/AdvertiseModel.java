...
public class AdvertiseModel {
	...
	public long add(AdvertiseBean bean) 
	    ...
	    try {
	        ...
	        String sql = "INSERT INTO st_advertisement (id, name, budget, start_date) VALUES (?, ?, ?, ?)";
	        ...
	        throw new ApplicationException("Exception in add Advertisement: " + e.getMessage());
