    ...
    <div align="center">
        ...
        <form action="<%=ORSView.PAYMENT_LIST_CTL%>" method="POST">
            <%
                ...
                List<PaymentBean> paymentList = (List<PaymentBean>) request.getAttribute("paymentList");
                ...
                <tr>
                    <td align="center">
                      <label><b> name :</b></label>
						<input type="text" name="payerName" placeholder="Enter  payerName" value="<%=ServletUtility.getParameter("payerName", request)%>">&emsp;
					 
                             <%=HTMLUtility.getList("payerName", String.valueOf(bean.getPayerName()), paymentList)%>
