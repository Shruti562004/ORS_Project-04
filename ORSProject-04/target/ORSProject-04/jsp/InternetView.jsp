        ...
        <div align="center">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="price" placeholder="Enter message" value="<%=DataUtility.getStringData(bean.getPrice())%>"></td>
                    <td style="position: fixed;">
                        <font color="red">
                ...
                <tr>
                    ...
                    <td><input type="text" name="limit" placeholder="Enter limit" value="<%=DataUtility.getStringData(bean.getLimit())%>"></td>
                    <td style="position: fixed;">
                        <font color="red">
